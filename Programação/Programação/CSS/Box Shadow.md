Basta usar a tag : box-shadow: 1px 1px 1px black (Exemplo)

1px - deslocamento horizontal
1px - deslocamento vertical
1px - blur
black - cor
...
--PODEMOS USAR UMA IMAGEM COMO BORDA EXEMPLO:

h1 {border: 10px solid rgb(0, 0, 0);
        padding: 5px;
        border-image-source: url("borda.png"); ---> nome do arquivo

        border-image-slice: 35;----> "distorção" da borda
        border-image-repeat: repeat; ---> tag para repitir a imagem
